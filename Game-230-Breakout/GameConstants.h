...
const int Message_X_Position = 400;
const int Message_Y_Position = 400;
const int Level_Name_Character_Size = 100;
...
const int Game_Start_Buffer_Time = 5 * Refresh_Frequency;
const int Game_End_Buffer_Time = 2 * Refresh_Frequency;
